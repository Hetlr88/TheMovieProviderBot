...
API_ID = int(environ.get('API_ID', '26545740'))
API_HASH = environ.get('API_HASH', '108df940118cde6c5f524f4d439a19d3')
BOT_TOKEN = environ.get('BOT_TOKEN', "7445547849:AAGy9K2aEeIjUf5zRJCLYe4BWvdoawRVc78")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6169288210').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002113795671').split()] #Channel id for auto indexing ( make sure bot is admin )
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://mrhex86:mrhex86@cluster0.8pxiirj.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "search")
